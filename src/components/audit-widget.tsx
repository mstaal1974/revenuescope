...
import { ChevronDown, ChevronUp, Lock, Award, Zap, BarChart, DollarSign, Target, UserCheck, Briefcase } from 'lucide-react';
...
const AuditWidget: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-1000">
      {/* 1. EXECUTIVE SUMMARY */}
      <div className="bg-slate-950 text-white text-left relative overflow-hidden border-b-2 border-blue-500/20 p-8 md:p-16">
      ...
      {result.sector_breakdown && (
        <div className="p-8 md:p-16 bg-slate-50 border-b border-slate-200">
      ...
      {/* 3. MICRO-STACK ARCHITECT */}
      <div className="bg-white rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border border-slate-200 max-w-7xl mx-auto overflow-hidden">
